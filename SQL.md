...
2. 索引的分类
   ...
   4. 前缀索引
      ...
      *创建前缀索引*
      ...
      3.真正的难点在于：`要选择足够长的前缀以保证较高的选择性，同时又不能太长， 前缀的长度应该使前缀索引的选择性接近索引整个列，即前缀的基数应该接近于完整列的基数`
3. 索引的数据结构
   ...
   ！[img](https://pic4.zhimg.com/80/v2-2d3d5c66d07323ca08711ef10ba7cb4b_1440w.webp)
